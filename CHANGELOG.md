...
## [1.11.4](https://github.com/ollien/vscode-neovim/compare/v1.15.2...v1.11.4) (2024-06-06)


### ⚠ BREAKING CHANGES

* use VSCode log level instead of our own ([#1962](https://github.com/ollien/vscode-neovim/issues/1962))
* The old composite commands are removed.
* vscode.get_status_item has been removed.
* **bindings:** enable bindings through configuration ([#1558](https://github.com/ollien/vscode-neovim/issues/1558))
* lua API ([#1532](https://github.com/ollien/vscode-neovim/issues/1532))
* **highlights:** redesign of highlighting approach ([#1449](https://github.com/ollien/vscode-neovim/issues/1449))
...
* release 0.4.0 ([ced7306](https://github.com/ollien/vscode-neovim/commit/ced7306622d0e39f71ede44513482452e35b1a5a))
* release 0.8.3 ([40ac24c](https://github.com/ollien/vscode-neovim/commit/40ac24cf2af8f97b37eb48a407ccd44f9b662fd3))
* release 0.9.1 ([11e7705](https://github.com/ollien/vscode-neovim/commit/11e77056d6d19af810b24401efa4d5ef16fc19f1))
* release 1.0.0 ([0aa53fe](https://github.com/ollien/vscode-neovim/commit/0aa53fe92c28cf737f09b91940c58bdacf7206df))
* release 1.10.0 ([95d3ca4](https://github.com/ollien/vscode-neovim/commit/95d3ca429febab9531551e222bf30ef0dc3ee74f))
* release 1.11.0 ([dc8d622](https://github.com/ollien/vscode-neovim/commit/dc8d6224bb42d9889854c9f69277bfeb35d399a5))
* release 1.11.4 ([3137516](https://github.com/ollien/vscode-neovim/commit/3137516c221a40f83b67c703137aad84f76868a7))


### fact

* **highlight:** ignore undesired highlights from vim side instead of vscode side ([#1334](https://github.com/ollien/vscode-neovim/issues/1334)) ([5ed8081](https://github.com/ollien/vscode-neovim/commit/5ed80815676217565fbdb759d7e1c26139e11a6c))
* **highlight:** remove easymotion support ([161371e](https://github.com/ollien/vscode-neovim/commit/161371ee385b1da0c9f6d0df7db2ef4c98498b62))


### Features

* `vscode.eval()` ([#1854](https://github.com/ollien/vscode-neovim/issues/1854)) ([32eedf0](https://github.com/ollien/vscode-neovim/commit/32eedf08fa7bce669666492b6515091352913ae4))
* add $NVIM_APPNAME option ([#1186](https://github.com/ollien/vscode-neovim/issues/1186)) ([5b54212](https://github.com/ollien/vscode-neovim/commit/5b5421201701be67fc92d42b39fb049708b4d0f1))
* add action `start-multiple-cursors` ([#1547](https://github.com/ollien/vscode-neovim/issues/1547)) ([f4a6ac5](https://github.com/ollien/vscode-neovim/commit/f4a6ac5bc2fd942a76402f27e3bb88df2924bba4))
* Add clipboard provider `g:vscode_clipboard` ([#1688](https://github.com/ollien/vscode-neovim/issues/1688)) ([c5346c8](https://github.com/ollien/vscode-neovim/commit/c5346c8c185840655291bd0b50daecf36b00285d))
* Add command "vscode-neovim.lua" ([#1622](https://github.com/ollien/vscode-neovim/issues/1622)) ([980f40a](https://github.com/ollien/vscode-neovim/commit/980f40a22aea5c20f2639c7e4ada5c5bcc107d44))
* add filetype module ([#1500](https://github.com/ollien/vscode-neovim/issues/1500)) ([56fbadc](https://github.com/ollien/vscode-neovim/commit/56fbadc729fe23d206c798acf61ad03a4c9ec0e5))
* Add option `afterInitConfig` ([#1695](https://github.com/ollien/vscode-neovim/issues/1695)) ([ec2b287](https://github.com/ollien/vscode-neovim/commit/ec2b287f891ae34935a1d4fff5602ae1fcbfd687))
* Add option `statusLineSeparator` ([#1521](https://github.com/ollien/vscode-neovim/issues/1521)) ([374d72f](https://github.com/ollien/vscode-neovim/commit/374d72f106ad685a63dc63709355778a2aeacc5b))
* add options to disable or change selection debounce time ([#1504](https://github.com/ollien/vscode-neovim/issues/1504)) ([2515e46](https://github.com/ollien/vscode-neovim/commit/2515e466a532ca280c8800d00e786de96cc0b1d9))
* Add vscode commands "restart" and "stop" ([#1566](https://github.com/ollien/vscode-neovim/issues/1566)) ([f2f57f8](https://github.com/ollien/vscode-neovim/commit/f2f57f82f1b9d7b16f52fd7977b7fb3d1e447280))
* Allow specifying WSL distro by wslDistribution ([#1693](https://github.com/ollien/vscode-neovim/issues/1693)) ([6c5dbcb](https://github.com/ollien/vscode-neovim/commit/6c5dbcb68a00ae2df29e61bdf91f9bf15987564d))
* **api:** add `vscode.get_status_item` ([#1576](https://github.com/ollien/vscode-neovim/issues/1576)) ([c20ce2f](https://github.com/ollien/vscode-neovim/commit/c20ce2fba5e07feeeac333a00be3dbf7575ed465))
* **api:** add `vscode.to_op` and refactor code actions ([#1570](https://github.com/ollien/vscode-neovim/issues/1570)) ([c9d600f](https://github.com/ollien/vscode-neovim/commit/c9d600f27de328d37d2d810f355ef6a0fdd2d1fc))
* **api:** support passing a map-like table as args ([#1670](https://github.com/ollien/vscode-neovim/issues/1670)) ([8fe3d8f](https://github.com/ollien/vscode-neovim/commit/8fe3d8f9d37ef5f980954c9e1eddbed882ee62ef))
* Auto find a suitable neovim executable ([#1894](https://github.com/ollien/vscode-neovim/issues/1894)) ([a0f5c25](https://github.com/ollien/vscode-neovim/commit/a0f5c253e3ce647f15040d063ec83cb31aa6acdc))
* better composite key support ([#1917](https://github.com/ollien/vscode-neovim/issues/1917)) ([44808b3](https://github.com/ollien/vscode-neovim/commit/44808b399a17aa1c59f64313773c6ea7b5fe2385))
* **bindings:** enable bindings through configuration ([#1558](https://github.com/ollien/vscode-neovim/issues/1558)) ([222a131](https://github.com/ollien/vscode-neovim/commit/222a131150745fc99c624b1f9eece9a91341df1a))
* **bindings:** global window navigations ([#1248](https://github.com/ollien/vscode-neovim/issues/1248)) ([88103a8](https://github.com/ollien/vscode-neovim/commit/88103a83010f57a24acf506610d4a89c7019aa20))
* **bindings:** handle C-d/C-u in hover widget ([#1744](https://github.com/ollien/vscode-neovim/issues/1744)) ([64c4cc7](https://github.com/ollien/vscode-neovim/commit/64c4cc7bb56a64aa8627b1a8bab9bee0446ea17c))
* **bindings:** support &lt;c-t&gt; as navigateBack ([#827](https://github.com/ollien/vscode-neovim/issues/827)) ([1cd8afb](https://github.com/ollien/vscode-neovim/commit/1cd8afb8401ee13d398ec836d990a97bee3ec7bc))
* **bindings:** z fold bindings for lists (incl. files explorer) ([#1250](https://github.com/ollien/vscode-neovim/issues/1250)) ([a86bd36](https://github.com/ollien/vscode-neovim/commit/a86bd36a062184be2a8739d88d50053cb53763f4))
* **buffer:** add external buffer doc provider (de48ee2) ([ba9d0dd](https://github.com/ollien/vscode-neovim/commit/ba9d0dde18bac45cb8c902360d65273b75eac80e))
* **ci:** add automatic releases ([#1244](https://github.com/ollien/vscode-neovim/issues/1244)) ([0bcee88](https://github.com/ollien/vscode-neovim/commit/0bcee88bbdb746a64fb58204a605797fdbdd14da))
* **cmdline:** integrate with native neovim completions ([#2001](https://github.com/ollien/vscode-neovim/issues/2001)) ([9ed0be0](https://github.com/ollien/vscode-neovim/commit/9ed0be0b0901d36509b79e1eab57aba136dbc722))
* **command line:** add a configurable completion timer delay ([#1467](https://github.com/ollien/vscode-neovim/issues/1467)) ([0cb897c](https://github.com/ollien/vscode-neovim/commit/0cb897c0d7805dafad5967602534a2f8b61ffadf))
* **cursor:** improve performance and flicker ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* **cursor:** remove range-based commands ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* **cursor:** send vscode selections to neovim, including intuitive mouse selections (remove mouse setting) ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* **cursor:** sync visual selections with vscode ([#1258](https://github.com/ollien/vscode-neovim/issues/1258)) ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* **dev:** pre-commit hooks ([#1853](https://github.com/ollien/vscode-neovim/issues/1853)) ([e2a36d8](https://github.com/ollien/vscode-neovim/commit/e2a36d872e23fd8e623d67dd9ccf5aa1e51d2f09))
* expose logs in OutputChannel, log info on startup [#1786](https://github.com/ollien/vscode-neovim/issues/1786) ([f77256b](https://github.com/ollien/vscode-neovim/commit/f77256be6afcaa596dc8c3cb9d4e6bc0cb12cfab))
* handle nvim statusline ([#1895](https://github.com/ollien/vscode-neovim/issues/1895)) ([fa5fc14](https://github.com/ollien/vscode-neovim/commit/fa5fc14389a0a5c5d97ec35458b826d052181a24))
* handle window change event ([#1417](https://github.com/ollien/vscode-neovim/issues/1417)) ([325b10f](https://github.com/ollien/vscode-neovim/commit/325b10f86916a906b6261d6f0fba60d3f6079b38))
* hide completion widgets when leaving insert mode ([#1478](https://github.com/ollien/vscode-neovim/issues/1478)) ([6d1dbba](https://github.com/ollien/vscode-neovim/commit/6d1dbbaa01e21fd71fde1d94ad1a1b504b1fc600))
* **highlights:** redesign of highlighting approach ([#1449](https://github.com/ollien/vscode-neovim/issues/1449)) ([f688d23](https://github.com/ollien/vscode-neovim/commit/f688d23669ac0a86e2cb6200d1970f9da6822634))
* improved the nvim version check ([#1527](https://github.com/ollien/vscode-neovim/issues/1527)) ([a42a60e](https://github.com/ollien/vscode-neovim/commit/a42a60e9e5ed9f958c4deaaa57d009067b14c1a9))
* Introduce `vscode-multi-cursor.nvim` ([#1553](https://github.com/ollien/vscode-neovim/issues/1553)) ([2657c45](https://github.com/ollien/vscode-neovim/commit/2657c4506b3dffe0d069db2891e30cebd963c2be))
* **keybindings:** add keybindings for output panel ([#1685](https://github.com/ollien/vscode-neovim/issues/1685)) ([12502e0](https://github.com/ollien/vscode-neovim/commit/12502e0a3d20cc8f0d21be7f121b34ce6c8bc815))
* **keybindings:** Add keybindings for the hover widget ([#1694](https://github.com/ollien/vscode-neovim/issues/1694)) ([68f0df8](https://github.com/ollien/vscode-neovim/commit/68f0df895bd9a08a35c692432de76e2c8cf4f1ee))
* **keybindings:** global window resize/split ([#1257](https://github.com/ollien/vscode-neovim/issues/1257)) ([9cb8aff](https://github.com/ollien/vscode-neovim/commit/9cb8aff9de313d157a22f5f1a6e7409582bd9757))
* **logging:** check that $VIMRUNTIME is readable [#1816](https://github.com/ollien/vscode-neovim/issues/1816) ([c9ddc3e](https://github.com/ollien/vscode-neovim/commit/c9ddc3ea90444e17b325c1b2c0c6756ad8d8374d)), closes [#1815](https://github.com/ollien/vscode-neovim/issues/1815)
* **logging:** log Nvim info at startup ([#1797](https://github.com/ollien/vscode-neovim/issues/1797)) ([6b174c8](https://github.com/ollien/vscode-neovim/commit/6b174c81d4327186d350643a4867f7155693d18a))
* lua API ([#1532](https://github.com/ollien/vscode-neovim/issues/1532)) ([80f10d2](https://github.com/ollien/vscode-neovim/commit/80f10d299a1858dd272bb0f9642c414188cfa1a0))
* **lua:** Add "vscode.with_insert" ([#2055](https://github.com/ollien/vscode-neovim/issues/2055)) ([be8812f](https://github.com/ollien/vscode-neovim/commit/be8812f7fbdc20917e18d844507001f2b347a07e))
* **lua:** add lua api ([#1339](https://github.com/ollien/vscode-neovim/issues/1339)) ([6be0ff3](https://github.com/ollien/vscode-neovim/commit/6be0ff383be87558a062e09cefb3c41e4e76625a))
* **main:** add options.lua ([#1254](https://github.com/ollien/vscode-neovim/issues/1254)) ([504d462](https://github.com/ollien/vscode-neovim/commit/504d46249f81351f8131109cb430e70424c0adb3))
* **mode:** switch to `ModeChanged` for more detailed mode information ([#1255](https://github.com/ollien/vscode-neovim/issues/1255)) ([97140a7](https://github.com/ollien/vscode-neovim/commit/97140a735b97d172bfb8c02a95def0d1675a232b))
* move output messages to a separate channel ([#2022](https://github.com/ollien/vscode-neovim/issues/2022)) ([39e1ae2](https://github.com/ollien/vscode-neovim/commit/39e1ae2c780289e77abd0eb207c80a61f7e5f6c4))
* optimize end-of-line highlighting rendering ([72bc537](https://github.com/ollien/vscode-neovim/commit/72bc5372c19dda231c20be683c718af0cc042d0c))
* **options:** prompt to enable experimental affinity([#1051](https://github.com/ollien/vscode-neovim/issues/1051), [#1267](https://github.com/ollien/vscode-neovim/issues/1267)) ([#1415](https://github.com/ollien/vscode-neovim/issues/1415)) ([482cfd8](https://github.com/ollien/vscode-neovim/commit/482cfd8a36c654163314fbbe4816a55bfa062d8e))
* **options:** synchronize editor line numbers ([#1426](https://github.com/ollien/vscode-neovim/issues/1426)) ([4a13f06](https://github.com/ollien/vscode-neovim/commit/4a13f06c08ae040ea7811376a4a8dddaf8007a59))
* override the default vim.ui interfaces ([#1710](https://github.com/ollien/vscode-neovim/issues/1710)) ([b522787](https://github.com/ollien/vscode-neovim/commit/b52278772a6b3557d8b05471b1fb90a2375f662a))
* override vim.lsp.buf methods ([#2045](https://github.com/ollien/vscode-neovim/issues/2045)) ([f7fbce1](https://github.com/ollien/vscode-neovim/commit/f7fbce1010090377f6050cc94e4a331a1eaaf9ca))
* R to refresh file explorer ([5464b48](https://github.com/ollien/vscode-neovim/commit/5464b48b4d4e6979dd0c2a61cdb76d2ffb06739f))
* revamp messages output channel ([#2024](https://github.com/ollien/vscode-neovim/issues/2024)) ([0957121](https://github.com/ollien/vscode-neovim/commit/09571212c176225ea3eca4f351296ed464b804b5))
* show output when return_prompt is sent ([#2029](https://github.com/ollien/vscode-neovim/issues/2029)) ([625397e](https://github.com/ollien/vscode-neovim/commit/625397efef2913321f090c93fb43ecb791182234))
* **statusline:** combine status line items ([#1429](https://github.com/ollien/vscode-neovim/issues/1429)) ([7f0de58](https://github.com/ollien/vscode-neovim/commit/7f0de58fd39add25d53d3ff074dc33fce88fa1eb))
* Support inccommand, including "split" ([c01e149](https://github.com/ollien/vscode-neovim/commit/c01e1496e1ec5a46872297cabb3ed0a46ecc6f1c))
* synchronize editor options and support `modeline` ([#1543](https://github.com/ollien/vscode-neovim/issues/1543)) ([a08c17d](https://github.com/ollien/vscode-neovim/commit/a08c17d1fb246101afa44077305fd5a15d4ba7e6))
* trigger FocusGained/Lost by default (80f10d29) ([5a4a36c](https://github.com/ollien/vscode-neovim/commit/5a4a36c434e9e2c6d6476c9d45a29c4f26adc8c5))
* use VSCode log level instead of our own ([#1962](https://github.com/ollien/vscode-neovim/issues/1962)) ([5f1bc49](https://github.com/ollien/vscode-neovim/commit/5f1bc495c2499f97448752489e1e1b2f5d466b9a))
* warn on empty `vscode-neovim.send` args ([#1455](https://github.com/ollien/vscode-neovim/issues/1455)) ([d1cbcf9](https://github.com/ollien/vscode-neovim/commit/d1cbcf977f84df110b5b94d53334b7c9fb98fd01))


### Bug Fixes

* [#1531](https://github.com/ollien/vscode-neovim/issues/1531) ([deb41d4](https://github.com/ollien/vscode-neovim/commit/deb41d463de8d04453f1ca5e2b8acf6393e7464a))
* account for level when handling cmdline_hide events ([#2034](https://github.com/ollien/vscode-neovim/issues/2034)) ([8760f81](https://github.com/ollien/vscode-neovim/commit/8760f81fd82d5daf3db70712cd379cd1356a0d18))
* add the missing "local" in "vscode.notify" ([2d8230c](https://github.com/ollien/vscode-neovim/commit/2d8230cc41cfe9ce23a1a56105182c4b98629a87))
* **api:** fix `VSCodeCall` ([35ec974](https://github.com/ollien/vscode-neovim/commit/35ec9743cbb6e6cae998da253da6e4885cc1eb63))
* auto stop extension when starting nvim failed ([#1703](https://github.com/ollien/vscode-neovim/issues/1703)) ([67e10ad](https://github.com/ollien/vscode-neovim/commit/67e10ad9db4a26995c39d670cd6478274d0dd5a8))
* **bindings:** {count}gt command not jumping to correct tab [#670](https://github.com/ollien/vscode-neovim/issues/670) ([a2c9b03](https://github.com/ollien/vscode-neovim/commit/a2c9b03bd995f941b16278a4f9ea402e8b9c063d))
* **bindings:** C-w in cmdline ([#1742](https://github.com/ollien/vscode-neovim/issues/1742)) ([048acea](https://github.com/ollien/vscode-neovim/commit/048acea91676c2216cf418c8bbfafae27f2c4a3a))
* **blockwise-visual:** handle double-width chars and tabs ([#1596](https://github.com/ollien/vscode-neovim/issues/1596)) ([c554c06](https://github.com/ollien/vscode-neovim/commit/c554c065a375f2bd32346aabdb6526ece8bb4189))
* **buffer, change:** save and restore local marks ([#1439](https://github.com/ollien/vscode-neovim/issues/1439)) ([9e194a0](https://github.com/ollien/vscode-neovim/commit/9e194a0ba3534b1e3b3473c625052388f1ba4a32))
* **buffer:** avoid sync conflicts during startup ([#1414](https://github.com/ollien/vscode-neovim/issues/1414)) ([0b3ab8f](https://github.com/ollien/vscode-neovim/commit/0b3ab8f7d53ba5271dadba54dfa37e90544737b9))
* **buffer:** bufname conflict when creating a new buffer ([#1652](https://github.com/ollien/vscode-neovim/issues/1652)) ([f304335](https://github.com/ollien/vscode-neovim/commit/f304335ce14388fbc47fb577a53f5ced681f0d6a))
* **buffer:** cancel visual mode when switching editor ([#1578](https://github.com/ollien/vscode-neovim/issues/1578)) ([15cb3d7](https://github.com/ollien/vscode-neovim/commit/15cb3d78b13360743a3466ade0de572981ca2203))
* **buffer:** Ensure proper cleanup of windows and buffers ([#1438](https://github.com/ollien/vscode-neovim/issues/1438)) ([7c9dc96](https://github.com/ollien/vscode-neovim/commit/7c9dc9671ba2010e3607f86fa3c7b3d061a4e808))
* **buffer:** prefer real path as buffer name ([#1699](https://github.com/ollien/vscode-neovim/issues/1699)) ([eff13f2](https://github.com/ollien/vscode-neovim/commit/eff13f2809f7992c48facb895e835ef214478d01))
* **buffer:** sync layout on doc closed ([#1706](https://github.com/ollien/vscode-neovim/issues/1706)) ([81951e7](https://github.com/ollien/vscode-neovim/commit/81951e70daebbe4d1448ffec1d02192d69e526ad))
* **buffer:** the output document should be modifiable ([#1416](https://github.com/ollien/vscode-neovim/issues/1416)) ([bc7e09b](https://github.com/ollien/vscode-neovim/commit/bc7e09b5125d9f04f168b9aaf4b017911df9daef))
* bump min nvim version ([#1495](https://github.com/ollien/vscode-neovim/issues/1495)) ([653c06f](https://github.com/ollien/vscode-neovim/commit/653c06f08e876404994d27893efc7d039c6d8f74))
* Cannot use strwidth to get string length ([#1635](https://github.com/ollien/vscode-neovim/issues/1635)) ([9e0cff5](https://github.com/ollien/vscode-neovim/commit/9e0cff5c6084b13ed99c44079ef9bf7494651d98))
* **change:** Fix bug in setting applyingEdits variable ([8f6447c](https://github.com/ollien/vscode-neovim/commit/8f6447c362b97fa12c3147a897b8714cfa846391))
* **change:** Respect the selections of the editor ([#1661](https://github.com/ollien/vscode-neovim/issues/1661)) ([4b8f242](https://github.com/ollien/vscode-neovim/commit/4b8f2429a95095bd9012a7c4769d172f5a3bc38a))
* **ci:** make husky executable ([b75a7f7](https://github.com/ollien/vscode-neovim/commit/b75a7f7bfbe67d67364e1197f9c9b15932729e33))
* clean up buffers properly ([#1428](https://github.com/ollien/vscode-neovim/issues/1428)) ([48ef8e6](https://github.com/ollien/vscode-neovim/commit/48ef8e6302f6f3d87897cc1c900af8dc1bca3593))
* cleanup temporary buffers for dotrepeat ([#1506](https://github.com/ollien/vscode-neovim/issues/1506)) ([7a3d5e9](https://github.com/ollien/vscode-neovim/commit/7a3d5e953dcd090dbc516a91c005ab76d97d35c2))
* **cmdline:** allow enter to accept cmdline after completion selected ([#2007](https://github.com/ollien/vscode-neovim/issues/2007)) ([d09891f](https://github.com/ollien/vscode-neovim/commit/d09891ff80c1088c5f8ab510a392ae682fc04bb1))
* **cmdline:** handle `wildmenu_hide` event ([#1541](https://github.com/ollien/vscode-neovim/issues/1541)) ([1b68475](https://github.com/ollien/vscode-neovim/commit/1b68475f190a80a74dee26ef37fc692d1a66c79a))
* **cmdline:** use Ctrl+n/p to select candidates when candidates exist ([1b68475](https://github.com/ollien/vscode-neovim/commit/1b68475f190a80a74dee26ef37fc692d1a66c79a))
* colliding ctrl+w bindings in terminal ([#1300](https://github.com/ollien/vscode-neovim/issues/1300)) ([f5a25f9](https://github.com/ollien/vscode-neovim/commit/f5a25f9d73649883af78b1331c8052cecb8e46d4))
* **config:** ignore init path when nvim running in clean mode ([#1503](https://github.com/ollien/vscode-neovim/issues/1503)) ([0615b3e](https://github.com/ollien/vscode-neovim/commit/0615b3e5190bcee9293a206c2c919a5e6b25bd24))
* correctly dispose the output channels ([#2033](https://github.com/ollien/vscode-neovim/issues/2033)) ([dde1b79](https://github.com/ollien/vscode-neovim/commit/dde1b798db9f9e1639dcc7e316be388949ac7563))
* Correctly set doc version for skipping changes ([#2037](https://github.com/ollien/vscode-neovim/issues/2037)) ([9e95dbe](https://github.com/ollien/vscode-neovim/commit/9e95dbe36cb3fac4c172cc35edbf46cc69dd8922))
* cursor position after scrolling with incsearch ([5fedba5](https://github.com/ollien/vscode-neovim/commit/5fedba50aff4de3fb742ba1877a07cdbbee581d3))
* **cursor_manager:** fix mouse selection without starting visual mode ([#1055](https://github.com/ollien/vscode-neovim/issues/1055)) ([2e74a3e](https://github.com/ollien/vscode-neovim/commit/2e74a3ea40bee16938eb8f6e81a566bf1cbf54d6))
* **cursor, visual:** fix sync mouse selection ([#1451](https://github.com/ollien/vscode-neovim/issues/1451)) ([bdf3b19](https://github.com/ollien/vscode-neovim/commit/bdf3b19a49611a9be94c795985cd7de5ff9b1259))
* **cursor:** always reveal the nvim cursor position ([#1911](https://github.com/ollien/vscode-neovim/issues/1911)) ([37f3434](https://github.com/ollien/vscode-neovim/commit/37f343455425c2f6a758f31eb09f644697683e9a))
* **cursor:** avoid unnecessary selections updates ([#1507](https://github.com/ollien/vscode-neovim/issues/1507)) ([bb0faed](https://github.com/ollien/vscode-neovim/commit/bb0faed07935c450128c857e154447623dd755f0))
* **cursor:** Current character not correctly obtained ([ed4e988](https://github.com/ollien/vscode-neovim/commit/ed4e988c5715973d58b0e68f4c8ce6f37f389383))
* **cursor:** cursor promise resolving ([9ed40f3](https://github.com/ollien/vscode-neovim/commit/9ed40f3db2cfb48f2b5cdea7e26acb35ef901136))
* **cursor:** don't overwrite cursor promise and wait for document change ([0d334af](https://github.com/ollien/vscode-neovim/commit/0d334af2c6ac352ccfd6f3cf25ea3b0d3f688e73))
* **cursor:** ensure normal visual mode for mouse selection ([#1463](https://github.com/ollien/vscode-neovim/issues/1463)) ([1b0ea63](https://github.com/ollien/vscode-neovim/commit/1b0ea63c67c5247e8451df8b94af7bdb0ff80f89))
* **cursor:** ignore cursor position errors in the output ([#1568](https://github.com/ollien/vscode-neovim/issues/1568)) ([08ef9d3](https://github.com/ollien/vscode-neovim/commit/08ef9d39f0b4cac79da2fadad380bb323088c007))
* **cursor:** optimized cursor synchronization debouncing ([#1406](https://github.com/ollien/vscode-neovim/issues/1406)) ([7326aae](https://github.com/ollien/vscode-neovim/commit/7326aaed7f8cd588e02869274f3f1df8c89086fd))
* **cursor:** re-add new `VSCodeNotifyRange` impl ([368c58d](https://github.com/ollien/vscode-neovim/commit/368c58db5fe5b6ae2bca37df3d6cfeb2fb98d62e))
* **cursor:** re-add new VSCodeNotifyRange impl ([#1358](https://github.com/ollien/vscode-neovim/issues/1358)) ([368c58d](https://github.com/ollien/vscode-neovim/commit/368c58db5fe5b6ae2bca37df3d6cfeb2fb98d62e))
* **cursor:** update position after exiting insert mode ([#1479](https://github.com/ollien/vscode-neovim/issues/1479)) ([da787ed](https://github.com/ollien/vscode-neovim/commit/da787ed0170637f8a9ca19c46d929189527aa7c6))
* **custom_commands:** wait for cursor update before issuing command ([368c58d](https://github.com/ollien/vscode-neovim/commit/368c58db5fe5b6ae2bca37df3d6cfeb2fb98d62e))
* detect potential module conflicts ([#2041](https://github.com/ollien/vscode-neovim/issues/2041)) ([04c6fc2](https://github.com/ollien/vscode-neovim/commit/04c6fc29269a636bd752230f8f59b132dc1efd29))
* **document_change:** eol is inconsistent when processing changes ([#1619](https://github.com/ollien/vscode-neovim/issues/1619)) ([6d870f9](https://github.com/ollien/vscode-neovim/commit/6d870f99cf15658d23d1fe1b003a555f56d7e5ad))
* don't show output panel after return_prompt, reverts [#2029](https://github.com/ollien/vscode-neovim/issues/2029) ([#2061](https://github.com/ollien/vscode-neovim/issues/2061)) ([6250a1d](https://github.com/ollien/vscode-neovim/commit/6250a1d00cea0fef7913c00b85176211ba7bc926))
* dot-repeat special symbols handling ([#1167](https://github.com/ollien/vscode-neovim/issues/1167)) ([5e955d6](https://github.com/ollien/vscode-neovim/commit/5e955d615b1bbc9257b3d299f48b84dd962062aa))
* **dotrepeat:** incorrect order of deletion and addition ([#1581](https://github.com/ollien/vscode-neovim/issues/1581)) ([5385c25](https://github.com/ollien/vscode-neovim/commit/5385c25d0c9462f3a679a5bb21c21936ce9da091))
* **dotrepeat:** should escape K_SPECIAL bytes ([68557f7](https://github.com/ollien/vscode-neovim/commit/68557f798d9bbc2225db9b8ab45b90664bcddf36))
* **eval:** try serializing the object result ([#1966](https://github.com/ollien/vscode-neovim/issues/1966)) ([b387d29](https://github.com/ollien/vscode-neovim/commit/b387d29568ca7976851fa7a1b485e204b7d34b08))
* fix command `vscode-neovim.stop` ([c8809ed](https://github.com/ollien/vscode-neovim/commit/c8809ed4c7591a75c960209c810120ddfa449f01))
* Fix forcing sync editor selections ([#1674](https://github.com/ollien/vscode-neovim/issues/1674)) ([7ebc1b2](https://github.com/ollien/vscode-neovim/commit/7ebc1b26384eee1a82a9449e238d60741a26d5e5))
* fix semver comparison ([d22850c](https://github.com/ollien/vscode-neovim/commit/d22850c42223c07571bdb40cb2ac48e8c232f8a7))
* fix setting client info in wsl ([#1687](https://github.com/ollien/vscode-neovim/issues/1687)) ([11e3cab](https://github.com/ollien/vscode-neovim/commit/11e3cab75b64c0075a96c1c6558061e5d568882f))
* Fix setting the cwd in remote development ([#2062](https://github.com/ollien/vscode-neovim/issues/2062)) ([62bab05](https://github.com/ollien/vscode-neovim/commit/62bab0597590ba4445b57b98653b2f0dd60ee002))
* fix sourcing our runtime files ([#1679](https://github.com/ollien/vscode-neovim/issues/1679)) ([567fea5](https://github.com/ollien/vscode-neovim/commit/567fea5674a24673ea2e48db528571b9ace72946))
* handle emoji characters ([#405](https://github.com/ollien/vscode-neovim/issues/405)) ([#1083](https://github.com/ollien/vscode-neovim/issues/1083)) ([9a06918](https://github.com/ollien/vscode-neovim/commit/9a06918890c149a42f674ca14d6e09ac1b9c03e8))
* handle timeout in eval properly ([#1863](https://github.com/ollien/vscode-neovim/issues/1863)) ([767f7ca](https://github.com/ollien/vscode-neovim/commit/767f7ca6a3c338b662edacabe833614cf7ea0221))
* highlight calculations race with buffer updates ([#1890](https://github.com/ollien/vscode-neovim/issues/1890)) ([53acfe5](https://github.com/ollien/vscode-neovim/commit/53acfe564012b9b1a20563d665791a8f28f810d5))
* **highlight:** avoid leftover highlights ([#1499](https://github.com/ollien/vscode-neovim/issues/1499)) ([72bc537](https://github.com/ollien/vscode-neovim/commit/72bc5372c19dda231c20be683c718af0cc042d0c))
* **highlight:** check highlight with blend for extmark ([#1075](https://github.com/ollien/vscode-neovim/issues/1075)) ([7e3ad92](https://github.com/ollien/vscode-neovim/commit/7e3ad92cf2cd69c2afb2c2724e0b2bde6a8c93ad))
* **highlight:** check overlay from config ([#1100](https://github.com/ollien/vscode-neovim/issues/1100)) ([53ff096](https://github.com/ollien/vscode-neovim/commit/53ff096ec44673bbdaa5e74814940ba96b99c32c))
* **highlight:** Do not clear custom highlight groups directly ([#1633](https://github.com/ollien/vscode-neovim/issues/1633)) ([f5381a7](https://github.com/ollien/vscode-neovim/commit/f5381a726ebb40c679d4c410659a11dc93d6b7da))
* **highlight:** do not widen the decoration's range ([deb41d4](https://github.com/ollien/vscode-neovim/commit/deb41d463de8d04453f1ca5e2b8acf6393e7464a)), closes [#1531](https://github.com/ollien/vscode-neovim/issues/1531)
* **highlight:** fix blank extmarks ([#1143](https://github.com/ollien/vscode-neovim/issues/1143)) ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* **highlight:** fix extmarks beyond end of line ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* **highlight:** forward search / matching in long lines ([#1976](https://github.com/ollien/vscode-neovim/issues/1976)) ([5fedba5](https://github.com/ollien/vscode-neovim/commit/5fedba50aff4de3fb742ba1877a07cdbbee581d3))
* **highlight:** Identify custom highlight group correctly ([#1628](https://github.com/ollien/vscode-neovim/issues/1628)) ([da15b14](https://github.com/ollien/vscode-neovim/commit/da15b1474dc19058e8b5037592b345ad3b6c54a4))
* **highlight:** ignore compound group names, like MatchParenVisual ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* **highlight:** limit special emoji handing to where it's relevant ([#1097](https://github.com/ollien/vscode-neovim/issues/1097)) ([#1099](https://github.com/ollien/vscode-neovim/issues/1099)) ([40cbbac](https://github.com/ollien/vscode-neovim/commit/40cbbac9a7f3e0e83c42f218f64065b6ddf125d2))
* **highlight:** make `borderColor` work ([#1557](https://github.com/ollien/vscode-neovim/issues/1557)) ([398d0fe](https://github.com/ollien/vscode-neovim/commit/398d0fed517211bf7335b9042ac39f8a015257f1))
* **highlight:** remove duplicate visual selection highlight ([#1643](https://github.com/ollien/vscode-neovim/issues/1643)) ([d02dbde](https://github.com/ollien/vscode-neovim/commit/d02dbde5832a3f5ac10249b2d3c40e778412166a))
* **highlight:** remove flash.nvim lag ([#1389](https://github.com/ollien/vscode-neovim/issues/1389)) ([e38e628](https://github.com/ollien/vscode-neovim/commit/e38e628b084a716cc5718545016f34cac28713f6))
* **highlight:** rendering all cells ([84344a5](https://github.com/ollien/vscode-neovim/commit/84344a5191156f95a357de627a778c406eb9cf81))
* **highlights:** fix highlights when emojis exist ([#1430](https://github.com/ollien/vscode-neovim/issues/1430)) ([050be0b](https://github.com/ollien/vscode-neovim/commit/050be0b37728e1aa2be7f74dac311deec896334b))
* **highlights:** fix misaligned rendering in visual mode ([#1401](https://github.com/ollien/vscode-neovim/issues/1401)) ([479f525](https://github.com/ollien/vscode-neovim/commit/479f525efac1b23e4ca146a96f7e7145b69b88d8))
* **highlight:** timely win hl ns setup, disable treesitter highlighting ([#1898](https://github.com/ollien/vscode-neovim/issues/1898)) ([eff4e20](https://github.com/ollien/vscode-neovim/commit/eff4e20010531278894bd30eb663ea12bd43f6a7))
* **highlight:** wait for document change before creating highlights ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* improve callAtomic error logging ([#1110](https://github.com/ollien/vscode-neovim/issues/1110)) ([91c0169](https://github.com/ollien/vscode-neovim/commit/91c01694be17e28af60530781762c311a378a792))
* include time and scope in log file ([#1951](https://github.com/ollien/vscode-neovim/issues/1951)) ([cccdf99](https://github.com/ollien/vscode-neovim/commit/cccdf9936c03a091e39811d55876c4dfab0dc7fb))
* **incsearch:** viewport is not updating during searching ([#1575](https://github.com/ollien/vscode-neovim/issues/1575)) ([b8696a3](https://github.com/ollien/vscode-neovim/commit/b8696a396c5ddffd0848f30a2c785aa05c2ca79a))
* **incsearch:** win cursor not properly revealed ([#1971](https://github.com/ollien/vscode-neovim/issues/1971)) ([116abdd](https://github.com/ollien/vscode-neovim/commit/116abddcb70a2daccf6fd9e29b51b08724c3141c))
* **keybinding:** fix `Ctrl+c` ([#1569](https://github.com/ollien/vscode-neovim/issues/1569)) ([4765026](https://github.com/ollien/vscode-neovim/commit/476502604a5fcfef89c528532de17b391036aed6))
* **keybindings:** fix ctrl+w in terminal ([#1297](https://github.com/ollien/vscode-neovim/issues/1297)) ([dc075aa](https://github.com/ollien/vscode-neovim/commit/dc075aaf7177a42c287230d79a09f3de292a7f8e))
* **keybinds:** Ctrl+n and Ctrl+p in cmdline ([#1533](https://github.com/ollien/vscode-neovim/issues/1533)) ([305bc1a](https://github.com/ollien/vscode-neovim/commit/305bc1aae7e444ee67ba5d5fe6438c9cda36f99f))
* **keybinds:** fix behavior of CTRL-m and CTRL-j ([#1886](https://github.com/ollien/vscode-neovim/issues/1886)) ([afb435d](https://github.com/ollien/vscode-neovim/commit/afb435df67189752d7e339d05ed42e57d622cd65))
* **logging:** infinite loop in BufferManager ([#1790](https://github.com/ollien/vscode-neovim/issues/1790)) ([b011631](https://github.com/ollien/vscode-neovim/commit/b0116315a018db9a8bb7a1d5df4a8f505dfa73f2)), closes [#1788](https://github.com/ollien/vscode-neovim/issues/1788)
* **lua:** rename vscode lua plugin to vscode-neovim ([#1356](https://github.com/ollien/vscode-neovim/issues/1356)) ([72adf16](https://github.com/ollien/vscode-neovim/commit/72adf160dcc5bc0066555c33c526140c2f835f95))
* **main:** set `WSLENV` to pass `NVIM_APPNAME` into WSL ([#1310](https://github.com/ollien/vscode-neovim/issues/1310)) ([2b27081](https://github.com/ollien/vscode-neovim/commit/2b270812de8d53a282550ec9aeb0176cbc4c0c36))
* maintain the order of positions for the Selection ([#1550](https://github.com/ollien/vscode-neovim/issues/1550)) ([8d76d51](https://github.com/ollien/vscode-neovim/commit/8d76d51cd6952c30ed5858587e64a97ab44c5da8))
* Match any ASCII characters in composite keys ([#1923](https://github.com/ollien/vscode-neovim/issues/1923)) ([51e2f11](https://github.com/ollien/vscode-neovim/commit/51e2f11c474ed7b1f9c2817f6e498805abca4ae2))
* **mode:** allow escaping from replace mode ([#1305](https://github.com/ollien/vscode-neovim/issues/1305)) ([76d473c](https://github.com/ollien/vscode-neovim/commit/76d473c6b97bcf582e3a9ee0806ccda8294dc9cf)), closes [#1304](https://github.com/ollien/vscode-neovim/issues/1304)
* **mode:** cmdline mode bindings [#1298](https://github.com/ollien/vscode-neovim/issues/1298) ([#1299](https://github.com/ollien/vscode-neovim/issues/1299)) ([6f4b9a0](https://github.com/ollien/vscode-neovim/commit/6f4b9a0ecb5a5d53a239c8c398eb41c066e9e44c))
* **mode:** synchronize mode after startup ([#1411](https://github.com/ollien/vscode-neovim/issues/1411)) ([3804505](https://github.com/ollien/vscode-neovim/commit/380450514efadd29074761e039657fd97bfc7008))
* **options:** force disable colorcolumn and winblend ([de11cf3](https://github.com/ollien/vscode-neovim/commit/de11cf32c72f3cc741efc18044ebefd5a12a62dc))
* properly set the client info ([c0422ef](https://github.com/ollien/vscode-neovim/commit/c0422efbf9cb0ee59989f7e7d52435019b8182a5))
* pulling status causes a redraw ([#2032](https://github.com/ollien/vscode-neovim/issues/2032)) ([fbc7c0d](https://github.com/ollien/vscode-neovim/commit/fbc7c0dc4c3a21ac3c801f800844b3673a32abbd))
* re-add `VSCodeCommentary` ([368c58d](https://github.com/ollien/vscode-neovim/commit/368c58db5fe5b6ae2bca37df3d6cfeb2fb98d62e))
* redraw events are processed in order ([#1940](https://github.com/ollien/vscode-neovim/issues/1940)) ([122eb56](https://github.com/ollien/vscode-neovim/commit/122eb56c9bd00570ea58b1da778fddb670437ae9))
* reduce text jumpiness when using the substitute command ([#1973](https://github.com/ollien/vscode-neovim/issues/1973)) ([d6e44dd](https://github.com/ollien/vscode-neovim/commit/d6e44dda9d46463879ae5733ee157dbae3c90a23))
* refactor buffer manager ([#1666](https://github.com/ollien/vscode-neovim/issues/1666)) ([1a27694](https://github.com/ollien/vscode-neovim/commit/1a2769478cb10483c449421e6ddb202bcf2c5472))
* remove check blend on overlay ([#1093](https://github.com/ollien/vscode-neovim/issues/1093)) ([3acf29c](https://github.com/ollien/vscode-neovim/commit/3acf29ce33b3685317292e50acc3351e591c3726))
* remove redundant error message on disconnect ([#2026](https://github.com/ollien/vscode-neovim/issues/2026)) ([95171d2](https://github.com/ollien/vscode-neovim/commit/95171d2aa7e5427e200f4fe214cd0e510c1a2dbb))
* rework `:tabnew` ([#1601](https://github.com/ollien/vscode-neovim/issues/1601)) ([1bff688](https://github.com/ollien/vscode-neovim/commit/1bff688386c6ec9e7aa48e8544fd66dd4b37e14b))
* rework visual-multi ([#1755](https://github.com/ollien/vscode-neovim/issues/1755)) ([0bd6834](https://github.com/ollien/vscode-neovim/commit/0bd68345fae514572c62927a81071af68963f78e))
* set an explicit id for status bar item ([#1941](https://github.com/ollien/vscode-neovim/issues/1941)) ([8c1f5a0](https://github.com/ollien/vscode-neovim/commit/8c1f5a093e13cf80638478f479c63807122d8bfd))
* set correct cwd for WSL ([#1689](https://github.com/ollien/vscode-neovim/issues/1689)) ([240e8f9](https://github.com/ollien/vscode-neovim/commit/240e8f9d0b4b14224242d86c3487cc6bd8a22fa0))
* set current dir in nvim ([#2078](https://github.com/ollien/vscode-neovim/issues/2078)) ([01aadaa](https://github.com/ollien/vscode-neovim/commit/01aadaa9f3074b0622d20daefc694b4933f3a8d7))
* set highlight group Subsitute ([#1983](https://github.com/ollien/vscode-neovim/issues/1983)) ([479638f](https://github.com/ollien/vscode-neovim/commit/479638fb0bac36d1d9f003e593f6ab43ca0d59b9))
* setup highlights timely ([#1964](https://github.com/ollien/vscode-neovim/issues/1964)) ([6c220c7](https://github.com/ollien/vscode-neovim/commit/6c220c7dc3f036529492a1fef197a790a24c2077))
* should setup highlights on WinNew,BufNew ([#1944](https://github.com/ollien/vscode-neovim/issues/1944)) ([178483c](https://github.com/ollien/vscode-neovim/commit/178483c4d6a7812976ffb0e7b88f84b25a425fed))
* skip window changed when target window id is 1000 ([#1667](https://github.com/ollien/vscode-neovim/issues/1667)) ([56ca01f](https://github.com/ollien/vscode-neovim/commit/56ca01f803056c79c04a0522b67637b6484706a0))
* sometimes eol highlight being displayed incorrectly ([#1988](https://github.com/ollien/vscode-neovim/issues/1988)) ([9e208f2](https://github.com/ollien/vscode-neovim/commit/9e208f24f50137e6899bb4c6743e09cc4adedc9d))
* **startup:** $VIMRUNTIME check fails on WSL [#1850](https://github.com/ollien/vscode-neovim/issues/1850) ([6db15d0](https://github.com/ollien/vscode-neovim/commit/6db15d02a1547e53a9373680a52fa6160346a1e7)), closes [#1848](https://github.com/ollien/vscode-neovim/issues/1848)
* tabstops now considered when calculating line width for highlights ([#1897](https://github.com/ollien/vscode-neovim/issues/1897)) ([bd4cbca](https://github.com/ollien/vscode-neovim/commit/bd4cbca3dac2bca45ecb32fd32a6eff8895de093))
* **test:** clean up reg '/' after cmdline testing ([#1453](https://github.com/ollien/vscode-neovim/issues/1453)) ([2bc2a80](https://github.com/ollien/vscode-neovim/commit/2bc2a807e7d7f3d18a72918fb0d790a564e1eb39))
* **test:** upgrade @vscode/test-electron ([#1690](https://github.com/ollien/vscode-neovim/issues/1690)) ([d3b25fd](https://github.com/ollien/vscode-neovim/commit/d3b25fd9b186a817a5232a6a524e0deeb238b6cf))
* **treesitter:** manually trigger parsing ([#1713](https://github.com/ollien/vscode-neovim/issues/1713)) ([c2ca1be](https://github.com/ollien/vscode-neovim/commit/c2ca1be787c9114bdb7dcc57e47d1932cd9fb878))
* **typing:** fix rapid typing after entering insert mode ([c01548e](https://github.com/ollien/vscode-neovim/commit/c01548e08a2c5edfec8a070a291a64aafc6a7db6))
* update expected cursor when multiple docs change ([#2035](https://github.com/ollien/vscode-neovim/issues/2035)) ([504da9e](https://github.com/ollien/vscode-neovim/commit/504da9eb1516c7890cf00d50b6916fd4c6578008))
* **viewport:** Avoid awaiting the hack to refresh viewport ([d5cb701](https://github.com/ollien/vscode-neovim/commit/d5cb701f845f90e9ca7b9d9943515b94c7211390))
* **viewport:** reduce cursor jitter (temporary solution) ([#1459](https://github.com/ollien/vscode-neovim/issues/1459)) ([237e795](https://github.com/ollien/vscode-neovim/commit/237e795fb48374fbef8a6a7cb7f40810630ab6ee))
* **visual:** clear fake cursor correctly ([#1552](https://github.com/ollien/vscode-neovim/issues/1552)) ([c786074](https://github.com/ollien/vscode-neovim/commit/c786074df01bc02d52856620d0da2db60659ae1a))
* **visual:** Fix syncing vscode selection to nvim ([#1647](https://github.com/ollien/vscode-neovim/issues/1647)) ([8d2a14a](https://github.com/ollien/vscode-neovim/commit/8d2a14a9171fd5cd25672fc68479333335a5f655))
* **visual:** optimized simulation of VisualChanged event ([#1597](https://github.com/ollien/vscode-neovim/issues/1597)) ([736e7b2](https://github.com/ollien/vscode-neovim/commit/736e7b261eeecacb163e0fc1b59a0a1dd4f1bbf8))
* **visual:** process selections in nvim ([#1603](https://github.com/ollien/vscode-neovim/issues/1603)) ([c202f52](https://github.com/ollien/vscode-neovim/commit/c202f527949d3af2f786b2a0cab71b96517d4657))
* vscode null in eval ([#1866](https://github.com/ollien/vscode-neovim/issues/1866)) ([923319a](https://github.com/ollien/vscode-neovim/commit/923319af2e2b41bd5e64f46dbf1fdac6262b170f))
* wait for appling selection changed ([#1551](https://github.com/ollien/vscode-neovim/issues/1551)) ([e1e1bf0](https://github.com/ollien/vscode-neovim/commit/e1e1bf01354495b3cf7a8731e2ec8729886532c6))
* wildmenu items are being set repeatedly ([#1989](https://github.com/ollien/vscode-neovim/issues/1989)) ([fc48f03](https://github.com/ollien/vscode-neovim/commit/fc48f03d405f4a3a0e77d9ed4ead7efa8292f05e))
* wildmenu sometimes not showing ([c01e149](https://github.com/ollien/vscode-neovim/commit/c01e1496e1ec5a46872297cabb3ed0a46ecc6f1c))
* wrong VSCode selections if cursor is at start of selection [#1180](https://github.com/ollien/vscode-neovim/issues/1180) ([f9bcd25](https://github.com/ollien/vscode-neovim/commit/f9bcd2555c01ad238d9eca06f1c051c43ee71b15))


### Documentation

* Add highlights section ([#1556](https://github.com/ollien/vscode-neovim/issues/1556)) ([5260b66](https://github.com/ollien/vscode-neovim/commit/5260b666218c53ed278cf89bd9ee376836dbd1b4))
* Add remote development section ([#1920](https://github.com/ollien/vscode-neovim/issues/1920)) ([08e47a1](https://github.com/ollien/vscode-neovim/commit/08e47a185590bda9b320d5045e25e4778256d47f))
* **contributing:** add CONTRIBUTING.md ([#1516](https://github.com/ollien/vscode-neovim/issues/1516)) ([c5178d1](https://github.com/ollien/vscode-neovim/commit/c5178d1a4f0969e85e51877ab828d7548af2a414))
* declutter keybindings reference ([#1620](https://github.com/ollien/vscode-neovim/issues/1620)) ([c5ad791](https://github.com/ollien/vscode-neovim/commit/c5ad7919a803336ffc9284846bc3a709d6ebd921))
* emphasize and clarify Lua api [#1617](https://github.com/ollien/vscode-neovim/issues/1617) ([1a5d2cf](https://github.com/ollien/vscode-neovim/commit/1a5d2cfb062ca7647c09c6e9bcd51d936bc1f04a))
* fix gramatical errors ([#1529](https://github.com/ollien/vscode-neovim/issues/1529)) ([ce68450](https://github.com/ollien/vscode-neovim/commit/ce68450502e52e9541f2f3f98450e5f7e7b5917d))
* Improve documentation and examples for composite keys ([#1933](https://github.com/ollien/vscode-neovim/issues/1933)) ([c0edf52](https://github.com/ollien/vscode-neovim/commit/c0edf52d042f477652778a75992fea08a62870fd))
* Improve the section on disabling keybindings ([#1638](https://github.com/ollien/vscode-neovim/issues/1638)) ([c7fe725](https://github.com/ollien/vscode-neovim/commit/c7fe725ecdb1b5d8a3c81d6a4f9b65ce6fcba62b))
* indicate you can view logs in the Debug Console ([#1995](https://github.com/ollien/vscode-neovim/issues/1995)) ([c00e7dc](https://github.com/ollien/vscode-neovim/commit/c00e7dc7141ad9c160e72701c393a53aeffa22d0))
* mention "vscode-neovim.neovimClean" ([#1774](https://github.com/ollien/vscode-neovim/issues/1774)) ([0ee3411](https://github.com/ollien/vscode-neovim/commit/0ee3411d0f490cd8e8457820403363089e7a3299))
* move keybindings to common section ([#1626](https://github.com/ollien/vscode-neovim/issues/1626)) ([d8c9d1c](https://github.com/ollien/vscode-neovim/commit/d8c9d1c75fa549839989acd92b5ddc880d65446c))
* **readme:** fix visual studio marketplace badge [#1127](https://github.com/ollien/vscode-neovim/issues/1127) ([fd152cf](https://github.com/ollien/vscode-neovim/commit/fd152cf8d539e3ae28a566d9aad6bca05208755f))
* typo ([509aaed](https://github.com/ollien/vscode-neovim/commit/509aaed3ad818ddb485084fdb853be8fbe07bb7c))


### Refactor

* Add "actions.lua" for executing internal lua functions ([#1605](https://github.com/ollien/vscode-neovim/issues/1605)) ([5f442aa](https://github.com/ollien/vscode-neovim/commit/5f442aaa702bdd8897795c6b84efa2ec71ef5751))
* add eventBus ([#1522](https://github.com/ollien/vscode-neovim/issues/1522)) ([bf803e3](https://github.com/ollien/vscode-neovim/commit/bf803e3b55e23ae0170be2c2a26de68624292a62))
* **api:** call Lua API within vim functions ([#1604](https://github.com/ollien/vscode-neovim/issues/1604)) ([efd9470](https://github.com/ollien/vscode-neovim/commit/efd94703615d685c16336cd7323eaa277a3e093d))
* check required version in nvim ([#1678](https://github.com/ollien/vscode-neovim/issues/1678)) ([f875e23](https://github.com/ollien/vscode-neovim/commit/f875e23190fa7a7187d7c1148838795e37cf30e8))
* clean up deprecated content ([#2012](https://github.com/ollien/vscode-neovim/issues/2012)) ([940cd4a](https://github.com/ollien/vscode-neovim/commit/940cd4a65cbc10a562aad790c4a4ab204540e914))
* **config:** use `vscode-neovim.restart` for restarting ([21e9da5](https://github.com/ollien/vscode-neovim/commit/21e9da53f073538d838dd97bcb421903f7824a94))
* **document_change:** simplify nvim to vscode change sync ([#1571](https://github.com/ollien/vscode-neovim/issues/1571)) (f10cb1a0) ([0510daf](https://github.com/ollien/vscode-neovim/commit/0510daf1389cc21b6a6d3b0768695d11b65a0cb0))
* don't hardcode substitute highlight ([#1991](https://github.com/ollien/vscode-neovim/issues/1991)) ([1b6bb7b](https://github.com/ollien/vscode-neovim/commit/1b6bb7b917ce31594826fea541547effc4622e7d))
* enable vscode-neovim.lua to accept an array of strings ([#1930](https://github.com/ollien/vscode-neovim/issues/1930)) ([8becac6](https://github.com/ollien/vscode-neovim/commit/8becac679ffed5ccfc86191d373c076d3abb2430))
* extract highlight provider grid logic into its own data structure ([#1901](https://github.com/ollien/vscode-neovim/issues/1901)) ([6d054de](https://github.com/ollien/vscode-neovim/commit/6d054de078b21e73f24ee45d57c6327dd39ae3cf))
* init output channels in the corresponding manager ([#2053](https://github.com/ollien/vscode-neovim/issues/2053)) ([927ed95](https://github.com/ollien/vscode-neovim/commit/927ed955d9075f40bb5f2f40d2ad9e057f13906c))
* **lua:** move autocmds,filetype to runtime/modules ([#1990](https://github.com/ollien/vscode-neovim/issues/1990)) ([c81e64d](https://github.com/ollien/vscode-neovim/commit/c81e64dd0f0502f79b14fe2430d7d442f347fd85))
* **lua:** rename the module vscode-neovim to vscode ([#1997](https://github.com/ollien/vscode-neovim/issues/1997)) ([109e125](https://github.com/ollien/vscode-neovim/commit/109e125210e4c2936e1775735e887a020fdd336a))
* move "vim/" and merge it into "runtime/" ([#2017](https://github.com/ollien/vscode-neovim/issues/2017)) ([3a5ecb2](https://github.com/ollien/vscode-neovim/commit/3a5ecb26086ca9f4add610e8d6844e1762e9d122))
* refactor configuration and logger ([#1471](https://github.com/ollien/vscode-neovim/issues/1471)) ([6bd3614](https://github.com/ollien/vscode-neovim/commit/6bd3614d6cde543a9349ea02b14853c29399bb28))
* register type commands only when needed ([#1931](https://github.com/ollien/vscode-neovim/issues/1931)) ([f25b899](https://github.com/ollien/vscode-neovim/commit/f25b8991993992987817a7a82185d63be3d1d2a1))
* remove the border of the custom highlights ([479638f](https://github.com/ollien/vscode-neovim/commit/479638fb0bac36d1d9f003e593f6ab43ca0d59b9))
* remove use of nvim_call_atomic [#1904](https://github.com/ollien/vscode-neovim/issues/1904) ([a63a34c](https://github.com/ollien/vscode-neovim/commit/a63a34c90f3cb9e1bd35bcaa66e0eabc37df239b))
* remove viewport hack when in cmdline mode ([5fedba5](https://github.com/ollien/vscode-neovim/commit/5fedba50aff4de3fb742ba1877a07cdbbee581d3))
* set enforced options in Lua ([#2011](https://github.com/ollien/vscode-neovim/issues/2011)) ([798792c](https://github.com/ollien/vscode-neovim/commit/798792c0b2c0c6e5ff1507b73fd5731f6bb6d31d))
* simplify highlight range building logic ([#1915](https://github.com/ollien/vscode-neovim/issues/1915)) ([f2d1a1d](https://github.com/ollien/vscode-neovim/commit/f2d1a1d3a7a8e1da610877b2cffbdbec988437d2))
* source "afterInitConfig" using nvim_exec2 ([#1705](https://github.com/ollien/vscode-neovim/issues/1705)) ([0aa3152](https://github.com/ollien/vscode-neovim/commit/0aa315261cf11c6561326a95f3d12a5d74499b1c))
* **tests:** cleanup and remove delays ([#1246](https://github.com/ollien/vscode-neovim/issues/1246)) ([0d334af](https://github.com/ollien/vscode-neovim/commit/0d334af2c6ac352ccfd6f3cf25ea3b0d3f688e73))
* use action for builtin multi-cursor feature ([f4a6ac5](https://github.com/ollien/vscode-neovim/commit/f4a6ac5bc2fd942a76402f27e3bb88df2924bba4))
* use builtin packageJson instead reading it manually ([550d53c](https://github.com/ollien/vscode-neovim/commit/550d53cc08b1551542ed00dafe68001b49e797d9))
* use event bus for vscode-neovim events ([#1528](https://github.com/ollien/vscode-neovim/issues/1528)) ([ecf1665](https://github.com/ollien/vscode-neovim/commit/ecf166519d45958252dbcf0f5c5cad317f411804))
* use scripts to maintain keybindings ([#1508](https://github.com/ollien/vscode-neovim/issues/1508)) ([2ea9272](https://github.com/ollien/vscode-neovim/commit/2ea92724c8b2adae2f811ddc2f0b967c721fbb6c))


### Performance Improvements

* Add VSCodeContext for perf improvement ([#1559](https://github.com/ollien/vscode-neovim/issues/1559)) ([62fbcc2](https://github.com/ollien/vscode-neovim/commit/62fbcc26fec546dbdef603ea7c1065ce1d511885))
* **highlight:** avoid redundant highlight IDs ([#1520](https://github.com/ollien/vscode-neovim/issues/1520)) ([a7cf325](https://github.com/ollien/vscode-neovim/commit/a7cf325003a5b1d42daf522491781f144f91c467))
